...
namespace moe
{
    ...
    void    ILogger::Log(LogChannel channel, LogSeverity severity, const char* file, int line, const char* format, const Args&... args)
    {
        ...
        IntrusiveListNode<ILogger>* loggerNode = this;
        do
        {
            ILogger* loggerOwner = loggerNode->Owner();
