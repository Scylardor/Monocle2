...
namespace moe
{
	...
	std::optional<OpenGLVertexElementFormat>	TranslateOpenGLVertexElementFormat(VertexElementFormat vtxFormat)
	{
		switch (vtxFormat)
		{
	...
	std::optional<uint32_t>	FindOpenGLTypeSize(std::uint8_t numCpnts, GLenum type)
	{
